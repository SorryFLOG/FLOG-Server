...
LuckywheelConfig.Prices = {
	[1]  = {type = 'car', 		name = 'car', 					count = 1, 		sound = 'car', 		probability = {a =   810, b = 990}},	--  0.1 %   0.1 -- VEHICLE
	...
	[12] = {type = 'item', 		name = 'casinochips', 			count = 15000, 	sound = 'chips', 	probability = {a = 300, b = 340}},	--  6.0 %  34.0 -- 15.000 chips
	...
	[16] = {type = 'item',		name = 'casinochips', 			count = 10000, 	sound = 'chips', 	probability = {a = 610, b = 640}},	--  8.0 %  64.0 -- 10.000 chips
