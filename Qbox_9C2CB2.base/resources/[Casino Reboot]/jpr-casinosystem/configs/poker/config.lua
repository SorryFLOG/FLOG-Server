...
Poker.TimeLeftAfter = 15 -- time remaining after one player betted (dealer actions start timeout)
Poker.PlayerDecideTime = 15 -- player decide time (when watching our cards)
Poker.HowToSpeed = 5000 -- x seconds to change to next
Poker.ShowCardsAfterReveal = true -- showing cameras on the players cards when revealing them
Poker.CanInteract = {member = true, vip = true, none = false}

Poker.Pokers = {
    [1] = {
        Position = vector3(996.17, 51.69, 68.45), 
        Heading = 318.91,
        PedPOS = vector4(996.82, 52.43, 68.43, 138.08),
        MaximumBet = 2500,
        MinimumBet = 50 
    },
    [2] = {
        ...
        Heading = 6.73,
        PedPOS = vector4(1000.62, 51.92, 68.43, 189.05),
        MaximumBet = 2500,
        MinimumBet = 50
    },
    [3] = {
        ...
        Heading = 3.39,
        PedPOS = vector4(984.91, 67.44, 69.24, 186.43),
        MaximumBet = 2000,
        MinimumBet = 50
    },
    [4] = {
        ...
        Heading = 191.77,
        PedPOS = vector4(998.65, 60.25, 68.43, 20.44),
        MaximumBet = 2000,
        MinimumBet = 50
    },
    [5] = {
        ...
        Heading = 237.13,
        PedPOS = vector4(995.65, 57.87, 68.43, 61.66),
        MaximumBet = 2000,
        MinimumBet = 50
    },
    [6] = {
        ...
        Heading = 278.52,
        PedPOS = vector4(989.25, 64.5, 69.24, 101.54),
        MaximumBet = 2000,
        MinimumBet = 50
    },
    [7] = {
        ...
        Heading = 200.84,
        PedPOS = vector4(991.83, 39.34, 69.24, 24.3),
        MaximumBet = 2000,
        MinimumBet = 50
    },
    [8] = {
        ...
        Heading = 279.25,
        PedPOS = vector4(994.02, 43.83, 69.24, 108.04),
        MaximumBet = 2000,
        MinimumBet = 50
    }
}
...
Poker.DealerAnimDictShared = 'anim_casino_b@amb@casino@games@shared@dealer@'
Poker.DealerAnimDictPoker = 'anim_casino_b@amb@casino@games@threecardpoker@dealer'
Poker.PlayerAnimDictShared = 'anim_casino_b@amb@casino@games@shared@player@'
Poker.PlayerAnimDictPoker = 'anim_casino_b@amb@casino@games@threecardpoker@player'

Poker.IncreaseAmounts = function(currentAmount)
...
Poker.GetCardType = function(cardArrayId)
...
Poker.GetCardValue = function(cardArrayId)
    local vals = {
        -- 2
        [2] = 2,
        [15] = 2,
...
Poker.getHandAllValues = function(handTable, bool_1, bool_2)
    if type(handTable) == 'table' then
        local c1, c2, c3 = Poker.GetCardValue(handTable[1]), Poker.GetCardValue(handTable[2]), Poker.GetCardValue(handTable[3])
        ...
        if (c1 ~= c2 and c1 ~= c3) and c2 ~= c3 then
            ...
            if Flush then
                ...
                if Poker.GetCardType(handTable[1]) == Poker.GetCardType(handTable[2]) and Poker.GetCardType(handTable[1]) == Poker.GetCardType(handTable[3]) then
        ...
        elseif c1 == c2 and c1 == c3 then -- 3 of a kind
            return c1 + c2 + c3 + 400
        elseif Poker.GetCardType(handTable[1]) == Poker.GetCardType(handTable[2]) and Poker.GetCardType(handTable[1]) == Poker.GetCardType(handTable[3]) then
            handValue = 200
        end
...
Poker.GetPairMultiplier = function(handValue)
...
Poker.GetAnteMultiplier = function(handValue)
    if handValue > 500 then
        return 5
    elseif handValue > 400 then
        return 4
...
Poker.formatHandValue = function(handValue)
    if handValue > 500 then
...
Poker.canDealerPlay = function(handValue)
